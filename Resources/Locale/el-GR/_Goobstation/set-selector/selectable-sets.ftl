...
selectable-set-blueshield-hardsuit-light-description = An armoured voidsuit, allowing for more speed at the cost of protection.
selectable-set-blueshield-modsuit-name = blueshield hardsuit
selectable-set-blueshield-modsuit-description = A custom hardsuit, allowing for more customisation, at the cost of requiring power.
...
selectable-set-engineering-voidsuit-desc = A light voidsuit for low-intensity repairs around the station
